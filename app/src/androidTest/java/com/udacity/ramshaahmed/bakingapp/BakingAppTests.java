...
import com.udacity.ramshaahmed.bakingapp.utils.BaseTest;
import com.udacity.ramshaahmed.bakingapp.utils.Navigation;
...
public class BakingAppTests extends BaseTest {
    ...
    public void checkAddWidgetButtonFunctionality() {
        ...
        Recipe recipe = Preferences.loadRecipe(globalApplication);
